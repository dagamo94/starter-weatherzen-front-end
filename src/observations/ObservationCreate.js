...
function ObservationCreate() {
    ...
    function submitHandler(event) {
        ...
        createObservation(observation)
            .then(() => { // async operation as it has to wait for the backend to write the data and respond with a success status
                history.push("/");
            })
            .catch(setError);
    }
        ...
        <main>
            ...
            <form onSubmit={submitHandler} className="mb-4">
                <div className="row mb-3">
                    ...
                    <div className="col-6">
                        <label className="from-label" htmlFor="longitude">
                            Longitude
                        </label>
                        <input
                            className="form-control"
                ...
                <div className="mb-3">
                    ...
                    >
                        ...
                        <option value="109">Thunderstorm</option>
                    </select>
                </div>
                <div>
                    <button
